...
import ru.netology.nikolaJ80.patient.entity.*;
...
import ru.netology.nikolaJ80.patient.service.alert.SendAlertServiceImpl;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String id1 = patientInfoRepository.add(
                new PatientInfo("Ivan", "Petrov", LocalDate.of(1980, 11, 26),
                        new HealthInfo(new BigDecimal("36.65"), new BloodPressure(120, 80)))
        );

        String id2 = patientInfoRepository.add(
                new PatientInfo("Semen", "Mikhailov", LocalDate.of(1982, 1, 16),
